...
class CreateView extends BorderPane {
    
    ArrayList<Recipe> recipes;
    RecipeList workingList;
    ...
    CreateView(ArrayList<Recipe> clist, RecipeList list, boolean create_new, int location, Stage currStage) {
